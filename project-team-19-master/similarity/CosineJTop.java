 ...
 */
public class CosineJTop extends JTop{
    public CosineJTop(int j, String word, Map<String, Map<String, Integer>> uniqueVectors){
    ...
    public Map<String, Double> getSimilarities(Map<String, Map<String, Integer>> uniqueVectors, Map<String, Integer> wordVector){
        ...
        while (uniqueVectorIterator.hasNext()){
            ...
            if (!mEntry.getKey().equals(stemmer.stem(word))){
                similarities.put((String)mEntry.getKey(), CompareVectors.CosineSim(wordVector, v));
            }
        }
        return similarities;
    }
    
    public Map<String, Double> getCosineJTop(){
